...
class Base
{
    const KEY = 'T34s934IadLs0897jhge43Bsaigafddf'; //支付秘钥需要更改成自己的
    const APPID = 'wx12dd820d8fbf8593'; //APPID需要更改为自己的
    ...
    const NOTIFY = 'http://www.wacoders.com/index.php/index/Flow/wxPaySuccess';   //支付通知地址需要更改成你自己服务器的地址
