<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"F:\wamp\www\shop/application/admin\view\category\edit.htm";i:1537327662;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1535422091;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid">
                                    ...
                                    <option <?php if($Categorys['pid'] == $cate['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-', $cate['level']*8)?><?php echo $cate['cate_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="cate_name" required="" value="<?php echo $Categorys['cate_name']; ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="iconfont" value="<?php echo $Categorys['iconfont']; ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">价格区间数</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="ps_num" value="<?php echo $Categorys['ps_num']; ?>" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                ?>
                                <div class="radio">
                                    <a href="javascript:;" onclick="add(this);"><?php echo $opt; ?></a>
                                    <select name="type_id[]">
                                        ...
                                        <?php if(is_array($typeRes) || $typeRes instanceof \think\Collection || $typeRes instanceof \think\Paginator): $i = 0; $__LIST__ = $typeRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;
                                            if($type['id'] == $v['type_id']){
                                                $selected = 'selected="selected"';
                                            }else{
                                                $selected = '';
                                            }
                                        ?>
                                        <option <?php echo $selected; ?> value="<?php echo $type['id']; ?>"><?php echo $type['type_name']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="show_cate" value="1" <?php if($Categorys['show_cate'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                        <span class="text">是</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input name="show_cate" value="0" <?php if($Categorys['show_cate'] == 0): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <img src="__uploads__/<?php echo $Categorys['cate_img']; ?>" height="30">
                                <?php else: ?>
                                暂无缩略图
                                <?php endif; ?>
                            </div>
