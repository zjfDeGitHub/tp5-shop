<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"F:\wamp\www\shop/application/admin\view\attr\list.htm";i:1511509521;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1535422091;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加商品属性" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Attr/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                            <?php if(is_array($attrRes) || $attrRes instanceof \think\Collection || $attrRes instanceof \think\Paginator): $i = 0; $__LIST__ = $attrRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td><?php if($attr['attr_type'] == 1): ?>单选<?php else: ?>唯一<?php endif; ?></td>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$attr['id'])); ?>')" class="btn btn-danger btn-sm shiny">
