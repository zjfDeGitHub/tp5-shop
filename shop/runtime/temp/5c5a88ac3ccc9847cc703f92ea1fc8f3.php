<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"F:\wamp\www\shop/application/index\view\cate\cate.htm";i:1516176157;s:55:"F:\wamp\www\shop/application/index\view\common\head.htm";i:1526908574;s:60:"F:\wamp\www\shop/application/index\view\common\cate_left.htm";i:1516176191;s:57:"F:\wamp\www\shop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <dl class="article-menu">
                ...
                <dd class="am-c">
                    ...
                    <div class="menu-item active">
                        ...
                        <ul class="item-bd">
                            <?php if(is_array($cate['children']) || $cate['children'] instanceof \think\Collection || $cate['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $cate['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$childCate): $mod = ($i % 2 );++$i;?>
        ...
        <div class="article-main">
            ...
            <div class="am-bd">
                ...
                <?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
					<li>
					    <h3><a href="<?php if($art['link_url']): ?> <?php echo $art['link_url']; else: ?> <?php echo url('index/Article/index',array('id'=>$art['id'])); endif; ?>" title="<?php echo $art['title']; ?>"><?php echo $art['title']; ?></a></h3>
					    <p></p>
					</li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
