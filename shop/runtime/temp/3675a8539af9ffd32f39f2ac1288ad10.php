<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"F:\wamp\www\shop/application/admin\view\link\list.htm";i:1510823128;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1532073981;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($linkRes) || $linkRes instanceof \think\Collection || $linkRes instanceof \think\Paginator): $i = 0; $__LIST__ = $linkRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center">
                                    <?php if($link['logo'] != ''): ?>
                                        <img src="__uploads__/<?php echo $link['logo']; ?>" height="30">
                                    <?php else: ?>
                                        暂无图片
                                    <?php endif; ?>
                                    </td>
                                    <td><?php echo cut_str($link['description'],10); ?></td>
                                    <td><?php echo cut_str($link['description'],10); ?></td>
                                    <td align="center">
