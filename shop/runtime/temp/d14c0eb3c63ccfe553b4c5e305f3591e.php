    ...
    <div class="user-main" ectype="userMain" data-action="noDefault">
        <div class="user-crumbs hide">
            <span><a href=".">首页</a></span><span class="arrow">&gt;</span> <span class="finish">进入会员中心</span>        </div>
                ...
                <div class="user-mod" style="min-height: 1018px;">
            <div class="user-title">
                <h2>我的订单</h2>
                <ul class="tabs">
                    <li <?php if($orderStatus == 1): ?> class="active" <?php endif; ?>><a href="<?php echo url('member/Order/orderList',['order_status'=>1]); ?>">全部订单(<?php echo $totalCount; ?>)</a></li>
                    <li <?php if($orderStatus == 2): ?> class="active" <?php endif; ?>">
                    <a href="<?php echo url('member/Order/orderList',['order_status'=>2]); ?>">待确认(<?php echo $notDoneCount; ?>)</a>
                    </li>
                    <li <?php if($orderStatus == 3): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo url('member/Order/orderList',['order_status'=>3]); ?>">待付款(<?php echo $notPayCount; ?>)</a>
                    </li>
                    <li <?php if($orderStatus == 4): ?> class="active" <?php endif; ?>" >
                    <a href="<?php echo url('member/Order/orderList',['order_status'=>4]); ?>">待收货(<?php echo $notGetCount; ?>)</a>
                    </li>
                    <li <?php if($orderStatus == 5): ?> class="active" <?php endif; ?>">
                    <a href="<?php echo url('member/Order/orderList',['order_status'=>5]); ?>">已完成(<?php echo $doneCount; ?>)</a>
                    </li>
                </ul>
                        ...
                        ?>
                            <dl class="item">
                                <dt class="item-t item-t-qb">
                                    <div class="t-statu">
                                        <div class="t-statu-name" id="ss_received_2">
                                        <?php
                                            if($v['order_status'] == 0){
                                                echo '未确认';
                                    ...
                                    <div class="t-info">
                                        <span class="info-item">订单号：<?php echo $v['out_trade_no']; ?></span>
                                        <span class="info-item"><?php echo date("Y-m-d H:i:s",$v['order_time']); ?></span>
                                        <span class="info-item"><?php echo $v['name']; ?></span>   
                                    </div>
                                    <div class="t-price"><em>¥</em><?php echo $v['order_total_price']; ?></div>
                                </dt>
                                <?php 
                                    if($v['goods']):
                                ...
                                <dd class="item-c">
                                    <div class="c-left">
                                                    <div class="c-goods" ectype="c-goods">
                                                                <div class="c-img"><a href="goods.php?id=708"><img src="__uploads__/<?php echo $v1['mid_thumb']; ?>" alt=""></a></div> 
                                                            <div class="c-info">
                                                <div class="o-info-lm">
                                                                            <a href="goods.php?id=708" class="info-name" target="_blank" title=""><?php echo $v1['goods_name']; ?></a>
                                                                        </div>
                                                <div class="fl">
                                                <div class="info-price mr10" style="width: auto;"><b><em>¥</em><?php echo $v1['member_price']; ?></b><i>×</i><span><?php echo $v1['goods_num']; ?></span></div>
                                                                    </div>
                                                                </div>
                                        </div>
                                                            </div>
                                    <?php if( $k1 == 0):?>
                                    <div class="c-handle" id="ss_msg_2">
                                        <a href="<?php echo url('member/Order/orderDetail',array('id'=>$v['id'])); ?>" class="sc-btn">订单详情</a>
                                        <a onclick="if (!confirm('您确认要删除该订单吗？')) return false;" href="<?php echo url('member/Order/orderDel',array('id'=>$v['id'])); ?>" class="sc-btn">删除订单</a>                                                        
                                    </div>
                                <?php endif;?>
                                </dd>
...
<script type="text/javascript" src="js/jquery.yomi.js"></script><script type="text/javascript">
$(function(){
