<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\wamp\www\shop/application/admin\view\member_level\list.htm";i:1512007054;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1517364350;}*/ ?>
<!DOCml html>
<html><head>
	    <meta charset="utf-8">
...
<button ml="button" tooltip="添加会员级别" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('memberLevel/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                            <?php if(is_array($mlRes) || $mlRes instanceof \think\Collection || $mlRes instanceof \think\Paginator): $i = 0; $__LIST__ = $mlRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ml): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td><?php echo $ml['level_name']; ?></td>
                                    <td><?php echo $ml['bom_point']; ?></td>
                                    <td><?php echo $ml['top_point']; ?></td>
                                    <td><?php echo $ml['rate']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('edit',array('id'=>$ml['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$ml['id'])); ?>')" class="btn btn-danger btn-sm shiny">
