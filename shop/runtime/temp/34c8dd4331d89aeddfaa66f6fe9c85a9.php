<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\wamp\www\shop/application/admin\view\order\orderselect.htm";i:1532074433;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1535422091;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">订单查询</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Order/lst'); ?>" method="post">
                        <div class="form-group">
                            <div class="col-sm-6">
                                <select name="select_base" style="float:left;">
                                    <option value="order_trade_no">订单号</option>
                                    <option value="username">用户名</option>
                                </select>
                                <input class="form-control" style="width:400px; float:left;" placeholder="" name="select_value" required="" type="text">
