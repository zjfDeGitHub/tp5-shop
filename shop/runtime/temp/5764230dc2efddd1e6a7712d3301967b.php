<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"F:\wamp\www\shop/application/index\view\coupons\index.htm";i:1546415656;s:55:"F:\wamp\www\shop/application/index\view\common\head.htm";i:1526908574;s:57:"F:\wamp\www\shop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="__index__/css/coupons.css" />
...
<div id="content" class="quan_content">
        ...
        <div class="w1200 w">
            <div class="quan-list">
                ...
                <div class="quan-item quan-d-item quan-item-acoupon">
                        <div class="q-type">
                            <div class="q-price"><em>￥</em><strong class="num"><?php echo intval($coupons['minus_price']);?></strong>       
                                <div class="txt" style="float: none;"><div class="typ-txt">全场券</div></div>
                                <div class="txt">
                                    <div class="limit"><span class="ftx-06">满<?php echo intval($coupons['goods_total_price']);?>元可用</span></div>
                                </div>
                            </div>
                            <div class="q-range">
                                <div class="range-item"><p title="<p>全品类</p>">
                                    <?php echo $coupons['cp_des']; ?>                              </p></div>
                                <div class="range-item">限 本店 可用</div>
                                <div class="range-item"><?php echo date("Y/m/d",$coupons['start_date']); ?>-<?php echo date("Y/m/d",$coupons['end_date']); ?></div>
                            </div>
                        </div>
                        <?php if(isset($uCoupons) && in_array($coupons['id'], $uCoupons)):?>
                        <div class="q-opbtns"><a href="<?php echo url('index/index/index'); ?>" class="q-btn get-coupon" cou_id="<?php echo $coupons['id']; ?>"><b class="semi-circle"></b>立即使用</a></div>
                        <div class="q-state"><div class="btn-state btn-geted">已领取</div></div>
                        <?php else:?>
                        <div class="q-opbtns"><a href="javascript:;" class="goget q-btn get-coupon" cou_id="<?php echo $coupons['id']; ?>"><b class="semi-circle"></b>立即领取</a></div>
                        <?php endif;?>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(".goget").click(function(){
            ...
            $.ajax({
                type:"GET",
                url:"<?php echo url('index/Coupons/takeCoupons', '', ''); ?>",
                dateType:"json",
                data:{id:id},
        ...
        $(document).on("click", ".pb-cl, .pb-x, .pb_close", function(){
            $("#coupons_dialog").remove();
            $("#pb-mask").remove();
        });
        $(document).on("click", ".color_df3134", function(){
            location.href="<?php echo url('index/index/index'); ?>";
        });
    </script>

        <input name="script_name" value="" type="hidden">
    <input name="cur_url" value="" type="hidden">
</div>
