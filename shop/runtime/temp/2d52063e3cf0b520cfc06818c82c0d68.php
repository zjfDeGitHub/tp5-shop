<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"F:\wamp\www\shop\public/../application/admin\view\order\edit.htm";i:1531231973;s:64:"F:\wamp\www\shop\public/../application/admin\view\common\top.htm";i:1517578989;s:65:"F:\wamp\www\shop\public/../application/admin\view\common\left.htm";i:1531213383;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
        ...
        <div class="widget">
            <div class="widget-body">
                ...
                <table class="table table-hover">
                                    <thead class="bordered-bottom bordered-blue">
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="username" value="<?php echo $orderInfo['username']; ?>" type="text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">
                                            ...
                                            <td>
                                                <input name="goods_total_price" value="<?php echo $orderInfo['goods_total_price']; ?>" type="text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="pay_status">
                                                    <option value="">请选择</option>
                                                    <option <?php if($orderInfo['pay_status'] == 0): ?> selected="selected" <?php endif; ?> value="0">未付款</option>
                                                    <option <?php if($orderInfo['pay_status'] == 1): ?> selected="selected" <?php endif; ?> value="1">已付款</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="country" value="<?php echo $orderInfo['country']; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="order_time" value="<?php echo date("Y-m-d H:i:s",$orderInfo['order_time']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">
