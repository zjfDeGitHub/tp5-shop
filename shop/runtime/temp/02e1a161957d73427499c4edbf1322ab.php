<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"F:\wamp\www\shop\public/../application/admin\view\order\ordergoodsedit.htm";i:1531301897;s:64:"F:\wamp\www\shop\public/../application/admin\view\common\top.htm";i:1517578989;s:65:"F:\wamp\www\shop\public/../application/admin\view\common\left.htm";i:1531213383;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('order/orderGoods',array('id'=>$orderGoodsInfo['order_id'])); ?>">订单商品管理</a>
                    </li>
                                        <li class="active">修改订单商品</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <input type="hidden" name="id" value="<?php echo $orderGoodsInfo['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">商品名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="goods_name" value="<?php echo $orderGoodsInfo['goods_name']; ?>" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">会员价</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $orderGoodsInfo['member_price']; ?>" placeholder="" name="member_price" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">本店价</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $orderGoodsInfo['shop_price']; ?>" placeholder="" name="shop_price" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">市场价</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $orderGoodsInfo['market_price']; ?>" placeholder="" name="market_price" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">商品属性</label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="goods_attr_str"><?php echo $orderGoodsInfo['goods_attr_str']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">商品数量</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $orderGoodsInfo['goods_num']; ?>" placeholder="" name="goods_num" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
