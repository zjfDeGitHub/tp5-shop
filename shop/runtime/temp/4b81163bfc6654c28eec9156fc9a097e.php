<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"F:\wamp\www\shop/application/admin\view\order\list.htm";i:1534929358;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1545535796;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div style="padding-bottom:10px;">
    <a href="<?php echo url('Order/lst'); ?>?status=no_paied" class="btn btn-blue"><b>未支付</b></a>
    <a href="<?php echo url('Order/lst'); ?>?status=paied" class="btn btn-sky"><b>已支付</b></a>
    <a href="<?php echo url('Order/lst'); ?>?status=no_post" class="btn btn-azure"><b>未发货</b></a>
    <a href="<?php echo url('Order/lst'); ?>?status=posted" class="btn btn-palegreen"><b>已发货</b></a>
    <a href="<?php echo url('Order/lst'); ?>?status=got_goods" class="btn btn-magenta"><b>已收货</b></a>
    <a href="<?php echo url('Order/exportOrders'); ?>?status=<?php echo $orderStatus; ?>" class="btn btn-darkorange"><b><i class="glyphicon glyphicon-retweet"></i>导出订单</b></a>
</div>
<div class="row">
