<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"F:\wamp\www\shop/application/member\view\user\userinfo.htm";i:1543752044;s:55:"F:\wamp\www\shop/application/index\view\common\head.htm";i:1526908574;s:56:"F:\wamp\www\shop/application/member\view\common\left.htm";i:1546920523;s:57:"F:\wamp\www\shop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
<dd>
    <p><a href="<?php echo url('member/Coupons/index'); ?>" target="_self">优惠券</a></p>
    </dd>
    </dl>
    </div></div>
    </div>
    ...
    <div class="user-main" ectype="userMain" data-action="noDefault">
                ...
                <div class="user-mod user-profile" style="min-height: 1018px;">
                ...
                <?php if($userInfo): ?>
                    <form name="formEdit" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="item">
                            ...
                            <div class="value"><span class="txt-lh2"><?php echo($_SESSION['think']['username']);?></span></div>
                        </div>
                        <div class="item">
                            <div class="label">昵称：</div>
                            <div class="value">
                                <input name="nick_name" type="text" value="<?php echo $userInfo['nick_name']; ?>" class="text text-1">
                                <div class="notic"></div>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="value">
                                <input name="avatar_src" type="file" value="">
                                <div style="margin-top:15px;">
                                    <?php if($userInfo['avatar_src']): ?>
                                        <img src="__uploads__/<?php echo $userInfo['avatar_src']; ?>" height="50">
                                    <?php else: ?>
                                        <img src="__index__/img/touxiang.jpg" height="50">
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="value">
                                <input name="year" type="text" value="<?php echo $userInfo['year']; ?>" class="imitate_select w90 mr10">
                                <input name="month" type="text" value="<?php echo $userInfo['month']; ?>" class="imitate_select w90 mr10">
                                <input name="date" type="text" value="<?php echo $userInfo['date']; ?>" class="imitate_select w90 mr10">
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="value">
                                <div class="radio-item">
                                    <input type="radio" <?php if($userInfo['sex'] == 1): ?> checked="checked" <?php endif; ?> id="sex-1" name="sex" value="1" class="ui-radio">
                                    <label for="sex-1" class="ui-radio-label">男</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" <?php if($userInfo['sex'] == 2): ?> checked="checked" <?php endif; ?> id="sex-2" name="sex" value="2" class="ui-radio">
                                    <label for="sex-2" class="ui-radio-label">女</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" <?php if($userInfo['sex'] == 3): ?> checked="checked" <?php endif; ?> id="sex-3" name="sex" value="3" class="ui-radio">
                                    <label for="sex-3" class="ui-radio-label">保密</label>
                                </div>
                            </div>
                        </div>
                         <div class="label">&nbsp;</div>
                            <div class="value" style="text-align:center;">
                                <input type="submit" name="" class="sc-btn sc-redBg-btn" value="确认修改">
                            </div>
                        </div>
                    </form>
                    <?php else: ?>
                    <form name="formEdit" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="item">
                            <div class="label">昵称：</div>
                            <div class="value">
                                <input name="nick_name" type="text" value="" class="text text-1">
                                <div class="notic"></div>
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            <div class="label">生日：</div>
                            <div class="value">
                                <input name="year" type="text" value="" class="imitate_select w90 mr10">
                                <input name="month" type="text" value="" class="imitate_select w90 mr10">
                                <input name="date" type="text" value="" class="imitate_select w90 mr10">
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">性别：</div>
                            <div class="value">
                                <div class="radio-item">
                                    <input type="radio" id="sex-1" name="sex" value="1" class="ui-radio">
                                    <label for="sex-1" class="ui-radio-label">男</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" id="sex-2" name="sex" value="2" class="ui-radio">
                                    <label for="sex-2" class="ui-radio-label">女</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" checked="checked" id="sex-3" name="sex" value="3" class="ui-radio">
                                    <label for="sex-3" class="ui-radio-label">保密</label>
                                </div>
                            </div>
                        </div>
                         <div class="label">&nbsp;</div>
                            <div class="value" style="text-align:center;">
                                <input type="submit" name="" class="sc-btn sc-redBg-btn" value="确认添加">
                            </div>
                        </div>
                    </form>
                    <?php endif; ?>
