<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:52:"F:\wamp\www\shop/application/admin\view\user\add.htm";i:1535764836;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1535422091;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="register_type" value="0" class="colored-blue" checked="checked" type="radio">
                                        <span class="text">邮箱</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="register_type" value="1" class="colored-blue" type="radio">
                                        <span class="text">手机</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input name="register_type" value="2" class="colored-blue" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="points" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">注册时间</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="留空则表示当前时间" name="register_time" type="text">
                            </div>
                        </div>
                        <div class="form-group">
