<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"F:\wamp\www\shop/application/index\view\goods\goods.htm";i:1526908893;s:55:"F:\wamp\www\shop/application/index\view\common\head.htm";i:1526908574;s:56:"F:\wamp\www\shop/application/index\view\common\right.htm";i:1516076657;s:57:"F:\wamp\www\shop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
</script><link rel="stylesheet" type="text/css" href="__index__/css/goods_fitting.css" />
...
<div class="preview" if="preview">
	<div class="gallery_wrap"><a href="__uploads__/<?php echo $goodsInfo['og_thumb']; ?>" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;"><img src="__uploads__/<?php echo $goodsInfo['big_thumb']; ?>" id="J_prodImg" alt="韩美格2017春秋新款修身大码蕾丝网纱打底衫女长袖薄款圆领女T恤 全店商品 二件减5元 三件减10"></a></div>
	<div class="spec-list">
		...
		<div class="spec-items">
			<ul>
				<?php if(is_array($goodsPhotoRes) || $goodsPhotoRes instanceof \think\Collection || $goodsPhotoRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsPhotoRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$midphotos): $mod = ($i % 2 );++$i;?>
            	 <li>
					<a href="__uploads__/<?php echo $midphotos['og_photo']; ?>" rel="zoom-id: Zoomer" rev="__uploads__/<?php echo $midphotos['big_photo']; ?>" >
<img src="__uploads__/<?php echo $midphotos['mid_photo']; ?>" alt="" width="58" height="58" />
					</a>
				</li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
...
<div class="si-warp"><div class="m-price" id="ECS_MARKETPRICE"><em>¥</em><?php echo $goodsInfo['markte_price']; ?></div></div>
                </div>
            <div class="si-info">
...
<div class="si-warp">
        ...
        <div class="summary-basic-info">
                ...
                <div class="summary-item is-integral">
                    ...
                    <div class="si-warp">
                        <!-- <label class="checkstatus"><input checked="checked" type="radio" name="color" value="黑色">黑色<i></i></label> -->
                        ...
                        <label <?php if($i == 1): ?> class="checkstatus" <?php endif; ?>><input <?php if($i == 1): ?> checked="checked" <?php endif; ?> type="radio" name="attr_<?php echo $attr['attr_id']; ?>" value="<?php echo $attr['id']; ?>"><?php echo $attr['attr_value']; if($attr['attr_price'] > 0): ?>[加<?php echo $attr['attr_price']; ?>元]<?php endif; if($attr['attr_price'] < 0): ?>[减<?php echo $attr['attr_price']*-1; ?>元]<?php endif; ?><i></i></label>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
...
<span>库存&nbsp;<em id="goods_attr_num" ectype="goods_attr_num"></em>&nbsp;个</span>
    ...
    <a href="javascript:bool=0;addToCartShowDiv(<?php echo $goodsInfo['id']; ?>);" class="btn-append" ectype="btn-append"><i class="iconfont icon-carts"></i>加入购物车</a>
...
<div class="track_warp">
    ...
    <div class="track-con" style="height:450px;">
        <ul>
    <li>
                <div class="p-img"><a href="goods.php?id=635" target="_blank" title="韩都衣舍2017韩版女装新款黑白拼接插肩棒球服春季短外套HH5597妠 朴信惠同款 黑白拼接 插肩袖 棒球服"><img src="__index__/img/0_thumb_G_1489102950633.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=634" target="_blank" title="新款韩版chic学生宽松短款外套上衣字母长袖连帽套头卫衣女潮"><img src="__index__/img/0_thumb_G_1489102753231.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=864" target="_blank" title="马克华菲长袖T恤男士圆领修身韩版刺绣纯棉2017春装新款潮t 7002 立体3D绣花 欧美潮流范 17春装新品"><img src="__index__/img/0_thumb_G_1490211620029.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=785" target="_blank" title="森马夹克 2016冬装新款男士飞行夹克贴布绣立领休闲外套韩版潮流"><img src="__index__/img/0_thumb_G_1490174208112.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=625" target="_blank" title="秋季新款男士套头卫衣印花外套韩版简约百搭潮流男生上衣服"><img src="__index__/img/0_thumb_G_1489099437211.jpg" width="140" height="140"></a></div>
...
<div class="mc-main" style="display:block;">
	...
	<div class="mcm-right">
		<ul>
<li>
				<div class="p-img"><a href="goods.php?id=864" title="马克华菲长袖T恤男士圆领修身韩版刺绣纯棉2017春装新款潮t 7002 立体3D绣花 欧美潮流范 17春装新品"><img src="__index__/img/0_thumb_G_1490211620029.jpg" width="130" height="130"></a></div>
...
<li>
				<div class="p-img"><a href="goods.php?id=863" title="马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98"><img src="__index__/img/0_thumb_G_1490211575591.jpg" width="130" height="130"></a></div>
				<div class="p-name"><a href="goods.php?id=863" title="马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98">马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98</a></div>
				<div class="p-price">
					<em>¥</em>98.00			</div>
			</li>
<li>
				<div class="p-img"><a href="goods.php?id=865" title="美特斯邦威长袖T恤男士2017春装新款时尚印花百搭205064商场同款 1元秒100元优惠券丨限量抢丨立即抢购"><img src="__index__/img/0_thumb_G_1490211700709.jpg" width="130" height="130"></a></div>
...
<div class="g-main g-history">
	...
	<div class="mc">
		<div class="mc-warp" id="history_list" ectype="history_mian">
			<ul>
				                				<li>
					<div class="p-img"><a href="goods.php?id=799" target="_blank" title="韩美格2017春秋新款修身大码蕾丝网纱打底衫女长袖薄款圆领女T恤 全店商品 二件减5元 三件减10"><img src="__index__/img/0_thumb_G_1490174858999.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>68.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=626" target="_blank" title="秋冬新款加绒圆领套头卫衣男青年男生韩版潮流学生休闲外套男"><img src="__index__/img/0_thumb_G_1489099544749.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>168.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=865" target="_blank" title="美特斯邦威长袖T恤男士2017春装新款时尚印花百搭205064商场同款 1元秒100元优惠券丨限量抢丨立即抢购"><img src="__index__/img/0_thumb_G_1490211700709.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>89.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=775" target="_blank" title="韩都衣舍2017韩版女装春装新款条纹显瘦百搭宽松v领七分袖衬衫潮 领券立减/单件包邮/七天无理由退换"><img src="__index__/img/0_thumb_G_1490169281436.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>78.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=768" target="_blank" title="韩都衣舍2017韩版女装夏装新款时尚修身显瘦圆领条纹T恤OGY7711娋 显瘦版型 舒适面料 条纹元素"><img src="__index__/img/0_thumb_G_1490169030833.jpg" width="170" height="170"></a></div>
...
<ul>
            <li>
        <div class="p-img"><a href="goods.php?id=684" target="_blank"><img src="__index__/img/0_thumb_G_1489109583798.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>555.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=685" target="_blank"><img src="__index__/img/0_thumb_G_1489109633806.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>1000.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=679" target="_blank"><img src="__index__/img/0_thumb_G_1489108999364.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>200.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=634" target="_blank"><img src="__index__/img/0_thumb_G_1489102753231.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>300.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=683" target="_blank"><img src="__index__/img/0_thumb_G_1489109337889.jpg" width="134" height="134"></a></div>
