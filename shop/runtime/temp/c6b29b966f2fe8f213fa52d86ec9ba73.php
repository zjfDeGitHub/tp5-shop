<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"F:\wamp\www\shop/application/admin\view\coupons\list.htm";i:1545795589;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1545535796;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加优惠券" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Coupons/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($couponsRes) || $couponsRes instanceof \think\Collection || $couponsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $couponsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$coupons): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $coupons['id']; ?></td>
                                    <td><?php echo $coupons['cp_name']; ?></td>
                                    <td><?php echo $coupons['cp_num']; ?></td>
                                    <td><?php echo $coupons['cp_taken_num']; ?></td>
                                    <td><?php echo $coupons['goods_total_price']; ?></td>
                                    <td><?php echo $coupons['minus_price']; ?></td>
                                    <td><?php echo date("Y-m-d",$coupons['start_date']); ?></td>
                                    <td><?php echo date("Y-m-d",$coupons['end_date']); ?></td>
                                    <td><?php echo date("Y-m-d H:i:s",$coupons['add_time']); ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('edit',array('id'=>$coupons['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <?php if($coupons['del_status'] == 0): ?>
                                        <a href="#" onClick="warning('确实要禁用吗', '<?php echo url('del',array('id'=>$coupons['id'])); ?>')" class="btn btn-danger btn-sm shiny">
