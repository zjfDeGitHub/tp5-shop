<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\wamp\www\shop/application/member\view\account\getpassword.htm";i:1520950106;}*/ ?>
...
<script type="text/javascript">
    ...
    // --------------------------------------------------------
    var check_send_msg="<?php echo url('member/Account/checkSendMsg'); ?>";
                                ...
                                <form action="user.php" method="post" name="getPhonePassword" ectype="form">
                                    <div class="item">
                                        ...
                                        <div class="item-info phone_code">
                                            ...
                                            <input type="botton"  id="btn" onclick="sendSms();" class="sms-btn" value="获取验证码">
                                        </div>
