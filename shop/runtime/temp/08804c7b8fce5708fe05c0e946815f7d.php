<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"F:\wamp\www\shop/application/index\view\flow\flow4.htm";i:1543136504;s:57:"F:\wamp\www\shop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="header header-cart">
    ...
    <div class="o-list">
                    ...
                    <!-- 支付按钮 -->
                    <?php if($orderInfo['payment'] == 1): ?>
                    <?php echo $payBtn; else: if($orderInfo['pay_status'] == 0): ?>
                    <img id="ewm" width="100" src="<?php echo url('index/Flow/wxewm',array('outTradeNo'=>$orderInfo['out_trade_no']),''); ?>">
                        <a href="<?php echo url('index/Flow/wxewm',array('outTradeNo'=>$orderInfo['out_trade_no']),''); ?>">微信支付</a>
                        <?php else: ?>
                        <img id="ewm" width="100" src="http://www.wacoders.com/public/static/index/img/wxpay.png">
                        <?php endif; endif; ?>
                </div>
...
<script type="text/javascript" src="__index__/js/warehouse.js"></script><script type="text/javascript" src="__index__/js/warehouse_area.js"></script>
    ...
    <script type="text/javascript" src="themes/ecmoban_dsc2017/js/region.js"></script>
        ...
        //微信支付状态
         function my_monitor(){
            var out_trade_no = <?php echo $orderInfo['out_trade_no']; ?>;
            $.ajax({
               type:"POST",
               ...
               success:function(res) {
                   if(res.pay_status == 1){
                        $("#ewm").attr('src','http://www.wacoders.com/public/static/index/img/wxpay.png');
