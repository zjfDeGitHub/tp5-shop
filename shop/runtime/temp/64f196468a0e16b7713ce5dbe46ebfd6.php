<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"F:\wamp\www\shop/application/admin\view\attr\edit.htm";i:1511510028;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1517364350;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改商品属性</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="type_id">
                                    ...
                                    <option  <?php if($attrs['type_id'] == $type['id']): ?> selected="selected" <?php endif; ?>  value="<?php echo $type['id']; ?>"><?php echo $type['type_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="attr_name" value="<?php echo $attrs['attr_name']; ?>" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="attr_type" value="1" <?php if($attrs['attr_type'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                        <span class="text">单选</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input name="attr_type" value="2" <?php if($attrs['attr_type'] == 2): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
