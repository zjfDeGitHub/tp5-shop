    ...
    <div class="user-main" ectype="userMain" data-action="noDefault">
        <div class="user-crumbs hide">
            <span><a href=".">首页</a></span><span class="arrow">&gt;</span> <span class="finish">进入会员中心</span>        </div>
             ...
             <!-- 优惠券列表开始 -->
             <div class="user-mod" ectype="tabSection" style="min-height: 408px;">
            <div class="user-title">
                <h2>优惠券列表</h2>
                <ul class="tabs" ectype="tabs">
                    <li <?php if($HcStatus == 0): ?>class="active"<?php endif; ?>><a href="<?php echo url('member/Coupons/index',['HcStatus'=>0]); ?>">未使用</a></li>
                    <li <?php if($HcStatus == 1): ?>class="active"<?php endif; ?>><a href="<?php echo url('member/Coupons/index',['HcStatus'=>1]); ?>">已使用</a></li>
                    <li <?php if($HcStatus == 2): ?>class="active"<?php endif; ?>><a href="<?php echo url('member/Coupons/index',['HcStatus'=>2]); ?>">已过期</a></li>
                    <li <?php if($HcStatus == 3): ?>class="active"<?php endif; ?>><a href="<?php echo url('member/Coupons/index',['HcStatus'=>3]); ?>">即将到期</a></li>
                </ul>
            </div>
            <div class="user-coupons-warp" ectype="tabContent">
                <div class="coupons_content_list" style="display: block;">

                <?php if(is_array($couponRes) || $couponRes instanceof \think\Collection || $couponRes instanceof \think\Paginator): $i = 0; $__LIST__ = $couponRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$coupons): $mod = ($i % 2 );++$i;?>
                    <div class="coupons-item ">
                            <div class="c-type">
                                <i class="i-left"></i>
                                <div class="c-t-cont">
                                    <div class="c-t-c-top">
                                        <strong><em>￥</em><?php echo intval($coupons['minus_price']); ?></strong>
                                        <span>消费满<?php echo intval($coupons['goods_total_price']); ?>元&nbsp;可用</span>
                                    </div>
                                    <div class="c-t-c-bot">
                                        <p>平台限制：本店</p>
                                        <p>范   围：[注册券][全品类通用]</p>
                                        <p><?php echo date("Y-m-d",$coupons['start_date']); ?> ~ <?php echo date("Y-m-d",$coupons['end_date']); ?></p>
                                    </div>
                                </div>
                                                            </div>
                                                        <div class="c-msg">
                                <a href="search.php?cou_id=1&amp;user_cou=1">
