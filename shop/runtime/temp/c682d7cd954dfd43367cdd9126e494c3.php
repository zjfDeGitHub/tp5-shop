<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"F:\wamp\www\shop/application/index\view\flow\flow1.htm";i:1528337593;s:57:"F:\wamp\www\shop/application/index\view\common\footer.htm";i:1522488208;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="goods-item">
    <div class="p-img">
                <a href="#" target="_blank"><img src="__uploads__/<?php echo $goods['mid_thumb']; ?>" width="70" height="70"></a>
            </div>
    <div class="item-msg">
...
<div class="amount-warp">
        ...
        <div class="a-btn" id="1">
    	        <a href="#" id="2" onclick="changenum('<?php echo $goods['goods_id_attr_id']; ?>', 1, 2, 16,17,this)" class="btn-add"><i class="iconfont icon-up"></i></a>
        <a href="#" onclick="changenum('<?php echo $goods['goods_id_attr_id']; ?>', 1, 2, 16,17,this)" <?php if($goods['goods_num'] == 1): ?> class="btn-reduce btn-disabled" <?php else: ?> class="btn-reduce" <?php endif; ?> ><i class="iconfont icon-down"></i></a>
            </div>
    </div>
