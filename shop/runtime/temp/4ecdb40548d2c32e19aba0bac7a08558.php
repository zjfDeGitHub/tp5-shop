<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"F:\wamp\www\shop\public/../application/admin\view\order\ordergoods.htm";i:1531301003;s:64:"F:\wamp\www\shop\public/../application/admin\view\common\top.htm";i:1517578989;s:65:"F:\wamp\www\shop\public/../application/admin\view\common\left.htm";i:1531213383;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($orderGoodsRes) || $orderGoodsRes instanceof \think\Collection || $orderGoodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $orderGoodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$orderGoods): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $orderGoods['id']; ?></td>
                                    <td><?php echo cut_str($orderGoods['goods_name'],13); ?></td>
                                    <td align="center"><?php echo $orderGoods['member_price']; ?></td>
                                    <td align="center"><?php echo $orderGoods['shop_price']; ?></td>
                                    <td align="center"><?php echo $orderGoods['market_price']; ?></td>
                                    <td align="center"><?php echo $orderGoods['goods_attr_str']; ?></td>
                                    <td align="center"><?php echo $orderGoods['goods_num']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('orderGoodsEdit',array('id'=>$orderGoods['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('orderGoodsDel',array('id'=>$orderGoods['id'])); ?>')" class="btn btn-danger btn-sm shiny">
