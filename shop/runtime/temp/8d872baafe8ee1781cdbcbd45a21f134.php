...
<div class="info">
    <p>待付款</p>
    <div class="num"><?php echo $notPayCount; ?></div>
</div>
</a>
    </li>
    <li>
...
<div class="info">
    <p>待收货</p>
    <div class="num"><?php echo $notGetCount; ?></div>
</div>
</a>
    </li>
    <li>
...
<?php if($myOrderList): 
    ...
    <div class="tr">
        ...
        <?php if(is_array($v['goods_id'])):
                foreach($v['goods_id'] as $k1=>$v1):
        ?> 
        <div class="c-img"><a href="<?php echo url('index/goods/index',['id'=>$v1]); ?>"><img src="__uploads__/<?php echo $v['thumbs'][$k1];?>" alt=""></a></div>

        <?php endforeach; else:?>
            <div class="c-img"><a href="<?php echo url('index/goods/index',['id'=>$v['goods_id']]); ?>"><img src="__uploads__/<?php echo $v['thumbs']; ?>" alt=""></a></div>
        <div class="c-info"><?php echo $v['goods_name'];?></div>
        <?php endif;?>
        </div>
        <div class="td td-price"><em>¥</em><?php echo $v['goods_total_price'];?></div>
        <div class="td td-name"><?php echo $leftUserInfo['nick_name']; ?></div>
        <div class="td td-statu">
        <?php if($v['order_status'] == 1): ?> 已确认 <?php else: ?> 未确认 <?php endif; ?>,
        <?php if($v['pay_status'] == 1): ?> 已付款 <?php else: ?> 未付款 <?php endif; ?>,
        <?php if($v['post_status'] == 0): ?> 未发货 <?php elseif($v['post_status'] == 1): ?> 已发货 <?php else: ?> 已收货 <?php endif; ?>,</div>
        <div class="td td-handle">
            <a href="user.php?act=order_detail&amp;order_id=7" class="sc-btn">订单详情</a>
        </div>
    </div>
    <?php endforeach;else: ?>
