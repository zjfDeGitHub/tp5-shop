<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"F:\wamp\www\shop/application/admin\view\conf\list.htm";i:1511343814;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1517364350;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                            ...
                            <tbody>
                                <?php if(is_array($confRes) || $confRes instanceof \think\Collection || $confRes instanceof \think\Paginator): $i = 0; $__LIST__ = $confRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php if($conf['conf_type'] == 1): ?>店铺配置<?php else: ?>商品配置<?php endif; ?>
                                        </td>
                                        <td align="center"><?php echo $conf['value']; ?></td>
                                        <td align="center"><?php echo $conf['values']; ?></td>
                                        <td align="center"><input type="text" style="width:60px; text-align:center;" name="sort[<?php echo $conf['id']; ?>]" value="<?php echo $conf['sort']; ?>" /></td>
                                        <td align="center">
                                ...
                                <tr><td colspan="9" align="right" style="padding-right:17%;"><input class="btn btn-primary btn-sm shiny" type="submit" value="提交" /></td></tr>
                            </tbody>
                        </table>
                    </form>
                </div>
