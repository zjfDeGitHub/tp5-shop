<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"F:\wamp\www\shop/application/admin\view\user\edit.htm";i:1536153056;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1535422091;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="username" value="<?php echo $userInfo['username']; ?>" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="留空则表示不修改" name="password" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">邮箱</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" value="<?php echo $userInfo['email']; ?>" name="email" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">电话</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" value="<?php echo $userInfo['mobile_phone']; ?>" name="mobile_phone" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">验证状态</label>
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="register_type" value="0" class="colored-blue" <?php if($userInfo['register_type'] == 0): ?> checked="checked" <?php endif; ?> type="radio">
                                        <span class="text">邮箱</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="register_type" value="1" <?php if($userInfo['register_type'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                        <span class="text">手机</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input name="register_type" <?php if($userInfo['register_type'] == 2): ?> checked="checked" <?php endif; ?> value="2" class="colored-blue" type="radio">
                                        <span class="text">均已验证</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">积分</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="points" value="<?php echo $userInfo['points']; ?>" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">注册时间</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="留空则表示当前时间" value="<?php echo date('Y-m-d h:i:s',$userInfo['register_time']); ?>" name="register_time" type="text">
                            </div>
                        </div>
                        <div class="form-group">
