<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"F:\wamp\www\shop/application/admin\view\recpos\list.htm";i:1516254243;s:54:"F:\wamp\www\shop/application/admin\view\common\top.htm";i:1517578989;s:55:"F:\wamp\www\shop/application/admin\view\common\left.htm";i:1532073981;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加推荐位" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('recpos/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                            <?php if(is_array($recposRes) || $recposRes instanceof \think\Collection || $recposRes instanceof \think\Paginator): $i = 0; $__LIST__ = $recposRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$recpos): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td><?php if($recpos['rec_type'] == 1): ?>商品推荐位<?php else: ?>分类推荐位<?php endif; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('edit',array('id'=>$recpos['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$recpos['id'])); ?>')" class="btn btn-danger btn-sm shiny">
